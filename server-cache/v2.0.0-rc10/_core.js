// AWS SDK for JavaScript v2.0.0-rc10
...
function Translator(api, options) {
  ...
  function setWaiters() {
    if (api.waiters) {
      translate.waiters = {};
      AWS.util.each(api.waiters, function (key, value) {
        var object = {};
        AWS.util.each(value, function (k2, v2) { object[inflect(k2)] = v2; });
...
},{"./core":32,"./http/xhr":40,"./services":53}],31:[function(require,module,exports){
var AWS = require('./core');
require('./credentials');
...
},{"./core":32,"./sequential_executor":46,"./service_interface/json":48,"./service_interface/query":49,"./service_interface/rest":50,"./service_interface/rest_json":51,"./service_interface/rest_xml":52,"util":28}],39:[function(require,module,exports){
var AWS = require('./core');
...
},{"../core":32,"../http":39,"events":11}],41:[function(require,module,exports){
var AWS = require('../core');
var inherit = AWS.util.inherit;
...
},{"./core":32,"./state_machine":93,"/Users/lsegal/aws/js/aws-sdk-js-dist-tools/node_modules/browserify/node_modules/insert-module-globals/node_modules/process/browser.js":13,"stream":19}],44:[function(require,module,exports){
...
},{"./core":32}],45:[function(require,module,exports){
var AWS = require('./core');
var inherit = AWS.util.inherit;
...
},{"./core":32}],46:[function(require,module,exports){
var AWS = require('./core');
...
},{"./core":32}],47:[function(require,module,exports){
(function (__dirname){
var AWS = require('./core');
...
},{"./api/translator":29,"./core":32,"fs":1}],48:[function(require,module,exports){
var AWS = require('../core');
...
},{"../core":32,"../json/builder":41}],49:[function(require,module,exports){
var AWS = require('../core');
var inherit = AWS.util.inherit;
...
},{"../core":32,"../xml/parser":96}],50:[function(require,module,exports){
var AWS = require('../core');
...
},{"../core":32}],51:[function(require,module,exports){
var AWS = require('../core');
require('./rest');
require('./json');
...
},{"../core":32,"./json":48,"./rest":50}],52:[function(require,module,exports){
var AWS = require('../core');
require('../xml/builder');
require('./rest');
...
},{"../core":32,"../xml/builder":95,"./rest":50}],53:[function(require,module,exports){
...
},{"./services/autoscaling":54,"./services/cloudformation":55,"./services/cloudfront":56,"./services/cloudsearch":57,"./services/cloudtrail":58,"./services/cloudwatch":59,"./services/datapipeline":60,"./services/directconnect":61,"./services/dynamodb":62,"./services/ec2":63,"./services/elasticache":64,"./services/elasticbeanstalk":65,"./services/elastictranscoder":66,"./services/elb":67,"./services/emr":68,"./services/glacier":69,"./services/iam":70,"./services/importexport":71,"./services/kinesis":72,"./services/opsworks":73,"./services/rds":74,"./services/redshift":75,"./services/route53":76,"./services/s3":77,"./services/ses":78,"./services/simpledb":79,"./services/simpleworkflow":80,"./services/sns":81,"./services/sqs":82,"./services/storagegateway":83,"./services/sts":84,"./services/support":85}],54:[function(require,module,exports){
var AWS = require('../core');
...
},{"../core":32}],85:[function(require,module,exports){
var AWS = require('../core');
...
},{"../core":32}],86:[function(require,module,exports){
var AWS = require('../core');
require('./v3');
var inherit = AWS.util.inherit;
...
},{"../core":32,"./v3":90}],87:[function(require,module,exports){
var AWS = require('../core');
var inherit = AWS.util.inherit;
...
},{"../core":32,"./cloudfront":86,"./s3":88,"./v2":89,"./v3":90,"./v3https":91,"./v4":92}],88:[function(require,module,exports){
var AWS = require('../core');
var inherit = AWS.util.inherit;
...
},{"../core":32}],90:[function(require,module,exports){
var AWS = require('../core');
var inherit = AWS.util.inherit;
...
},{"../core":32,"./v3":90}],92:[function(require,module,exports){
var AWS = require('../core');
var inherit = AWS.util.inherit;
...
},{"../core":32}],93:[function(require,module,exports){
...
},{"./core":32,"/Users/lsegal/aws/js/aws-sdk-js-dist-tools/node_modules/browserify/node_modules/insert-module-globals/node_modules/process/browser.js":13,"buffer":2,"crypto":6,"fs":1,"url":26}],95:[function(require,module,exports){
var AWS = require('../core');
...
},{"../core":32,"xmlbuilder":101}],96:[function(require,module,exports){
var AWS = require('../core');
var inherit = AWS.util.inherit;
...
},{"../core":32,"xml2js":97}],97:[function(require,module,exports){
(function() {
...
},{"events":11,"sax":98}],98:[function(require,module,exports){
(function (Buffer){
;(function (sax) {
...
},{"buffer":2,"stream":19,"string_decoder":25}],99:[function(require,module,exports){
(function() {
...
},{"./XMLFragment":100}],100:[function(require,module,exports){
(function() {
  var XMLFragment,
    __hasProp = {}.hasOwnProperty;
